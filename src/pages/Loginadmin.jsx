...
import loginImg from "../assets/admin.svg";
      ...
      <section className="grid grid-cols-2 grid-flow-row">
        ...
        <div className="flex flex-nowrap flex-col flex-1 relative">
          ...
          <div className=" flex flex-col justify-center items-center h-full mt-8">
            <form
              className="absolute w-[400px] mt-1 mr-9 flex flex-col gap-y-6 "
              method="POST">
              <h1
                className="font-bold text-xl mb-[-10px] text-[#132F2B] tracking-wide"
                dir="rtl">
                تسجيل الدخول بالبريد الالكتروني كطبيب
              </h1>
